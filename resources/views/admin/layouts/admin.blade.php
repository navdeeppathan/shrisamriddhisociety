...
<body class="mode-dark">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="{{ route('admin.deposits.index') }}" class="nav-link {{ Request::is('admin/deposits*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12h6m-6 4h6M7 4h7l5 5v11a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2z"/>
            ...
            <div class="nav-item">
                <a href="{{ route('admin.loan.payments.index') }}" class="nav-link {{ Request::is('admin/loan-payments*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12h6m-6 4h6M7 4h7l5 5v11a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2z"/>
                    ...
                    <span class="nav-text">Loan Payments</span>
                </a>
            </div>
