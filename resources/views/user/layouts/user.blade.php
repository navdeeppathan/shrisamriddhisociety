...
<body class="mode-dark">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="{{ route('user.loans') }}" class="nav-link {{ Request::is('user/my-loans*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 6h7v7H4V6zm9 0h7v7h-7V6zM4 15h7v3H4v-3zm9 0h7v3h-7v-3z"/>
            ...
            <div class="nav-item">
                <a href="{{ route('user.loan.payments') }}" class="nav-link {{ Request::is('user/my-loan-payments*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 6h7v7H4V6zm9 0h7v7h-7V6zM4 15h7v3H4v-3zm9 0h7v3h-7v-3z"/>
                    ...
                    <span class="nav-text">Loans Payments</span>
                </a>
            </div>

            <div class="nav-item">
                <a href="{{ route('user.deposits') }}" class="nav-link {{ Request::is('user/my-deposits*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 6h7v7H4V6zm9 0h7v7h-7V6zM4 15h7v3H4v-3zm9 0h7v3h-7v-3z"/>
